                ...
                <div class="main-product">
                    <a href="{{url('product/bogo-12week-custom-meal-plan')}}">
                        <img class="desktop-image"
                             src="{{ asset('web/images/home_page/top_banner/banner_12_week_custom_plan-2.jpg')}}"/>
                        <img class="mobile-image"
                             src="{{ asset('web/images/home_page/top_banner/mobile/banner_12_week_custom_plan_mob.jpg')}}">
                    </a>
                </div>
