        ...
        <section class="section__wrapper total-results">
            <div class="wrapper">
                ...
                <div class="total-results__img">
                    <img src="{{ asset('web/images/full-product/book.png')}}" alt="book" class="full-width desktop-image" />
                    <img src="{{ asset('web/images/full-product/book_mob.png')}}" alt="book" class="full-width mobile-image" />
                </div>
