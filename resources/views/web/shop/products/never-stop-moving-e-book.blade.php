...
@section('content')
        ...
        <section class="section__wrapper total-results" style="background-image:url({{ asset('web/images/full-product/never-stop-moving/bg.png') }})">
            <div class="wrapper">
                ...
                <div class="total-results__img">
                    <img src="{{ asset('web/images/full-product/never-stop-moving/book@2x-3.png')}}" alt="book"
                         class="full-width desktop-image"/>
                    <img src="{{ asset('web/images/full-product/never-stop-moving/book_mob@2x-2.png')}}" alt="book"
                ...
                <div class="training-plan-faqs-block">
                    ...
                    <ul class="training-plan-faqs-list">
                        ...
                        <li class="training-plan-faqs-list-item">
                            <p class="item-title">
                                <strong>
                                    I struggle with falling off the wagon. Am I going to have a hard time completing the
                                    program?
                                </strong>
                            </p>
                            <p class="item-description">
                                This guide is exactly what you need! In addition to the workouts, this program offers
                                recovery tips as well as tips for staying on track when the weekends arrive.
                            </p>
                        </li>
                        <li class="training-plan-faqs-list-item">
                            <p class="item-title">
                                <strong>
                                    My best friend and I are training partners, will we be able to complete this program
                                    together?
                                </strong>
                            </p>
                            <p class="item-description">
                                YES! Actually, that is one of the greatest things about this guide. It is an investment
                                that not only you, but your friends and family can take advantage of as well.
                            </p>
                        </li>
                    </ul>
                </div>
    ...
    <div class="popUp" data-modal="12 Week Custom Meal Plan"><!-- popUp--open -->
        <div class="popUp__wrapper">
            ...
            <p class="popUp__subTitle">Combine Never Stop Moving and our Custom Meal Plan to achieve greater
                results.</p>
