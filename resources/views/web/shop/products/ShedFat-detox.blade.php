    ...
    <main>
        ...
        <section class="section__wrapper detox-section green-page-section">
            <div class="wrapper">
                ...
                <div class="flex flex-j--between detox-section__wrapper green-page-section__wrapper" style="align-items: center;">
                    ...
                    <div class="detox-section__block green-page-section__block detox-section__block--right green-page-section__block--right">
                    <img src="{{ asset('web/images/full-product/illustration.png')}}" alt="why-detox">
                    </div>
                </div>
            </div>
        </section>
