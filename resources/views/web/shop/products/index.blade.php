...
@section('content')
    <main>
<div class="main">
    <div class="wrapper" style="background-color: #efea48;text-align: center;"><h2 style="padding: 15px;">60% OFF <span style="font-weight: lighter;">THE ENTIRE STORE</span></h2></div>
