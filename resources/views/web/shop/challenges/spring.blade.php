                ...
                <div class="sc-prizes-block">
                    ...
                    <div class="sc-prizes-columns-wrapper">
                        ...
                        <div class="sc-prizes-column-single">
                            ...
                            <h5 class="sc-prizes-column-sub-title">
                                2 winners
                                <br>
                                Male and Female
                            </h5>
                                        ...
                                        <li class="amazingcarousel-item">
                                            <div class="amazingcarousel-item-container">
                                                <div class="amazingcarousel-image">
                                                    <a href="https://player.vimeo.com/video/224869579" title="Rauve workout plan GYM"  class="html5lightbox" data-group="amazingcarousel-1">
                                                        <img src="https://i.vimeocdn.com/video/644018264.jpg"  alt="Rauve workout plan GYM" />
                                                    </a>
                                                </div>
                                            </div>
                                        </li>
                        ...
                        <div class="sc-rules-regulations-list-wrapper">
                            <ul class="sc-rules-regulations-list">
                                <li class="sc-rules-regulations-list-item">
                                    In order to participate and qualify for the cash prizes you must register in the designated registration window listed above.
                                </li>
                                <li class="sc-rules-regulations-list-item">
                                ...
                                <li class="sc-rules-regulations-list-item">
                                    All contestants will be judged on their before and after photo submissions. One photo showing a frontal view and one photo showing a side view.
                                </li>
                                <li class="sc-rules-regulations-list-item">
                                ...
                                <li class="sc-rules-regulations-list-item">
                                    Winners will be selected by the Shedfat Team and will be determined by what we consider to be the most drastic, most impressive overall change in body composition and will be announced at 9pm on Friday, September 8
                                    <sup>th</sup>
                                    .
                                </li>
                            </ul>
