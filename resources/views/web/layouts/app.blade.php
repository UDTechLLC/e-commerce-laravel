...
<head>
    ...
    @section('style')
        ...
        <link rel="stylesheet" href="{{ mix('web/css/base.min.css') }}">
        {{--<link rel="stylesheet" type="text/css" href="{{ asset('web/carouselengine/initcarousel-1.css') }}">--}}
        {{-- <link href="https://use.fontawesome.com/releases/v5.0.6/css/all.css" rel="stylesheet">--}}
        <link rel="stylesheet" type="text/css" href="{{ asset('web/slick/slick.min.css') }}">
        <link rel="stylesheet" type="text/css" href="{{ asset('web/slick/slick-theme.min.css') }}">
        <!--[if lt IE 9]!!>
...
@section('scripts')
    ...
    <script src="{{ asset('web/js/flipdown.min.js')}}"></script>
    <script src="{{ asset('web/js/script.min.js') }}"></script>
    <script src="{{ asset('web/js/modal.min.js')}}"></script>
