...
<script type="text/babel">
    export default ({
        ...
        methods: {
            getSubscriptions() {
                let url = `/admin/subscriptions/getSubscriptions?page=${this.pagination.currentPage}&sortType=${this.sortParam.type}&sortField=${this.sortParam.field}&searchField=${this.searchField}&searchValue=${this.searchQuery}`;
                axios.get(url).then(
                        response => {
