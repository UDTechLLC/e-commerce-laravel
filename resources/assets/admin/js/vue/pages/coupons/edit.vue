        ...
        <form id="demo-form3" data-parsley-validate class="form-horizontal form-label-left" method="post">
            ...
            <div class="form-group" :class="{'has-error': errors.has('description') }">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea class="form-control"
                              ...
                              name="description" v-model="coupon.description" rows="3"></textarea>
            ...
            <div class="form-group" :class="{'has-error': errors.has('coupon_amount') }">
                ...
                <div class="col-md-3 col-sm-3 col-xs-12">
                    <input type="number" id="old-price" v-model="coupon.coupon_amount"
            ...
            submitForm() {
                ...
                this.$validator.validateAll().then((result) => {
                    if (result) {
                        ...
                        axios.post(`/admin/coupons/update/${this.coupon.id}`, data).then(
                                result => {
