                    ...
                    <div class="header-cart-wrapper">
                        ...
                        <ul class="header-cart-items">
                            <li class="header-cart-item">
                                <a href="#" class="flex flex-a--center flex-j--between">

                                        <span class="header-cart-item__image">
                                            <img src="assets/images/full-product/devices.png" alt="">
                                        </span>
        ...
        <div class="wrapper">
            <div class="flex flex-j--between flex-a--center flex--m-block">
                <a href="/" class="header-logo">
                    <img src="assets/images/logos/Shedfat-logo.png" alt="Shedfat-logo">
                </a>
